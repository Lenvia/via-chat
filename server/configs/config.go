...
var AppJsonConfig = []byte(`
{
  "app": {
    "port": "8322",
    "upload_file_path": "/Users/yy/GithubProjects/via-web/tmp_images/",
    "cookie_key": "4238uihfieh49r3453kjdfg",
    "debug_mod": "true"
  },
  "mysql": {
    "dsn": "root:y724290941@tcp(mysql-container)/room?charset=utf8mb4&parseTime=True&loc=Local"
  }
}
`) // 如果要在本地运行，需要把mysql-container或172.17.0.2（docker中的mysql的IP）改成127.0.0.1
